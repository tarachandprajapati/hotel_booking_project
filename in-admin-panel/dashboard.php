...
<title>IN ADMIN PANEL | Simply C</title>
...
<div id="main_container">
    ...
    <div class="right_header">Welcome Admin, <a href="#">Visit site</a> | <a href="#" class="messages">(3) Messages</a> | <a href="logout.php" class="logout">Logout</a></div>
...
Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
    ...
    <h2>Hotel Rooms details modification settings :</h2> 
...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded">Hotel Id</th>
            <th scope="col" class="rounded">Room Id</th>
    ...
    <!-- <h2>Warning Box examples</h2>
     ...
     <h2>Submit the hotel information here :</h2>
     
         <div class="form">
         <form action="myGuest.php" method="post" class="niceform">
         
                <fieldset>
                    <dl>
                        <dt><label >Hotel Name</label></dt>
                        <dd><input type="text" name="hotel_name" id="" size="54" required/></dd>
                    </dl>
                    <dl>
                        <dt><label >City</label></dt>
                        <dd><input type="text" name="city" id="" size="54" required/></dd>
                    </dl>
                    <dl>
                        <dt><label >No of rooms</label></dt>
                        <dd><input type="text" name="no_of_rooms" id="" size="54" required /></dd>
                    </dl>
                    <dl>
                        <dt><label >Price/Night</label></dt>
                        <dd><input type="text" name="price_per_night" id="" size="54" required /></dd>
                    </dl>
                    <dl>
                        <dt><label >Rating</label></dt>
                        <dd><input type="text" name="rating" id="" size="54" required /></dd>
                    </dl>
                    <dl>
                        <dt><label >Remarks</label></dt>
                        <dd><input type="text" name="remarks" id="" size="54" required/></dd>
                    </dl>
                   <!-- <dl>
                    ...
                    <dl>
                        <dt><label >Select tags:</label></dt>
                        <dd>
                            <input type="checkbox" name="interests[]" id="" value="Wi-fi" /><label class="check_label">Wi-fi</label>
                            <input type="checkbox" name="interests[]" id="" value="Bar-lounge" /><label class="check_label">Bar-lounge</label>
                            <input type="checkbox" name="interests[]" id="" value="Smoking" /><label class="check_label">Smoking</label>
                            <input type="checkbox" name="interests[]" id="" value="king-size bed" /><label class="check_label">king-size bed</label>
                        </dd>
                    </dl>
                    ...
                    <dl>
                        ...
                        <dd>
                            <input type="radio" name="type" id="" value="normal" /><label class="check_label">Normal</label>
                            <input type="radio" name="type" id="" value="air_conditioned" /><label class="check_label">Air Contditioned</label>
                            <input type="radio" name="type" id="" value="premium_suite" /><label class="check_label">Premium suite</label>
                        </dd>
                    </dl>
                    <dl>
                        <dt><label >Upload thumbnail of room:</label></dt>
                        <dd><input type="file" name="fileToUpload" id="fileToUpload" /></dd>
                    </dl>
                    <dl>
                        <dt><label >Capacity</label></dt>
                        <dd><input name="capacity" id="comments" ></input></dd>
                    </dl>
                    <dl>
                        <dt><label >Contents</label></dt>
                        <dd><textarea name="contents" id="comments" rows="5" cols="36"></textarea></dd>
                    </dl>
    ...
    <div class="footer">
    	...
    	<div class="left_footer">IN ADMIN PANEL | Powered by <a href="http://indeziner.com">Simply C</a></div>
